# Google image scraping from https://github.com/behroozfalsafi/Scrape-Google-Images/blob/main/google_image_scraper.py
...
def scrape_and_save_images(search_term, base_folder, num_images=10):
    folder_path = os.path.join(base_folder, search_term)
    ...
    print(f"Getting and saving {len(image_urls)} images")
    for index, image_url in tqdm(enumerate(image_urls, start=1)):
...
if __name__ == "__main__":
    base_folder = r"C:\Users\bf100\Desktop"
